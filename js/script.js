...
$(document).ready(function() {
  ...
  // Hide the color label for extra credit
    $("#colors-js-puns")[0].firstElementChild.style.display = "none";

  $("#color")[0].value = "Please select a T-shirt theme";
  
  // Add a change event for the design dropsown
  $("#design").on("change", function() {
	  
	// Show the color label for extra credit
        $("#colors-js-puns")[0].firstElementChild.style.display = "block";

    // Show the color select menu for extra credit
  ...
  $('div p:contains("If you selected the Bitcoin")').hide();
   ...
   $('#payment option:first').hide();
     ...
     // Set the credit card option by default
    $("#payment")[0].value = "credit card";
